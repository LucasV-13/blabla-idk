...
$site_url = "/"; // Remplacez par l'URL de votre site
?>
...
<body>
    <!-- Header avec boutons -->
    <div class="header">
        <a href="<?php echo $site_url; ?>dashboard.php" class="header-btn" id="dashboardBtn" aria-label="<?php echo $texts['dashboard']; ?>">
    ...
    <div id="settingsModal" class="modal settings-modal">
        <div class="modal-content">
            ...
            <a href="<?php echo $site_url; ?>profil/profil.php">
                <button class="settings-btn" id="profileBtnModal"><?php echo $texts['access_profile']; ?></button>
            </a>
            
            <hr>
            
            <form method="post" action="<?php echo $site_url; ?>logout.php" id="logoutForm">
    ...
    <script src="java/jsMenu.js"></script>
</body>
</html>